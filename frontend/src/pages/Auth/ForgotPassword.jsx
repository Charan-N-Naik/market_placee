...
export default function ForgotPassword() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setApiError(error.response?.data?.message || 'Failed to send reset email');
    } finally {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 p-4 relative overflow-hidden">
      ...
      >
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input 
                  {...register('email')}
                  className={`block w-full px-4 py-3 bg-gray-50 border ${errors.email ? 'border-red-300' : 'border-gray-200'} rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all`}
        ...
        <div className="mt-8 text-center">
          <Link to="/" className="inline-flex items-center text-sm font-bold text-gray-500 hover:text-gray-800 transition-colors">
